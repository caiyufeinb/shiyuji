...
/**
 * 该类是温性食物RecyclerView的适配器，用来在RecyclerView中显示用户拥有的温性食物
 */
public class warmAdapter extends RecyclerView.Adapter<warmAdapter.ViewHolder> {
    ...
    构造函数，将包含数据的数组传入
     */
    public warmAdapter(List<Warm> warmList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //用来提示自己点击的 是哪种类型的食物
                intent.putExtra(bag_foodActivity.TYPE, "warm");
