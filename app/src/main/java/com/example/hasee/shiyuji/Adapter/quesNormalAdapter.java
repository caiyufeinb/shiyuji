 ...
 */
public class quesNormalAdapter extends RecyclerView.Adapter<quesNormalAdapter.ViewHolder> {
    ...
    构造函数，将包含数据的数组传入
     */
    public quesNormalAdapter(List<Normal> normalList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Normal normal = normalList.get(position);
                //创建对话框对象,设置基本属性
