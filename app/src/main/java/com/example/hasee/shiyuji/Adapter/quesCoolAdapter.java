 ...
 */
public class quesCoolAdapter extends RecyclerView.Adapter<quesCoolAdapter.ViewHolder> {
    private static final String TAG = "quesCoolAdapter";
    ...
    构造函数，将包含数据的数组传入
     */
    public quesCoolAdapter(List<Cool> cools) {
        coolList = cools;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Cool cool = coolList.get(position);
                //创建对话框对象,设置基本属性
    ...
    */
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.coldName.setText(cool.getFoodName());
        Glide.with(context).load(cool.getImageId()).into(holder.coldImage);
    }
